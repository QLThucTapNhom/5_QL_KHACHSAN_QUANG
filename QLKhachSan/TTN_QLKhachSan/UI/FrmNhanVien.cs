    ...
    public partial class FrmNhanVien : Form
    {
        ...
        private void BtnThem_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (manv.Length != 0 && ten.Length != 0 && gtinh.Length != 0 && cmt.Length != 0 && chucvu.Length != 0)
                {
                    ...
                    {
                        MessageBox.Show("CMND 9 hoặc 12 số!", "", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
        ...
        private void BtnXoa_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    MessageBox.Show("Vui lòng diền đủ thông tin!", "Mời bạn kiểm tra lại", MessageBoxButtons.OK, MessageBoxIcon.Stop);
                }
            }
            catch
            {
        ...
        private void comboBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            db.loadDateTime(dtpNgaySinh, "select NgaySinh from NHANVIEN where MaNV = N'" + manv + "'");
        }
        ...
        private void dgvNhanVien_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (dgvNhanVien.Rows[a].Cells[0].Value.ToString() == "")
            {
                return;
            }
            ...
            txtCMT.Text = dgvNhanVien.Rows[a].Cells[2].Value.ToString().Trim();
